...
const LandingPage = ({ onOpenInvitation }) => {
  ...
  // Helper functions for AM/PM + "onwards"
  ...
  function formatAgendaTime(startTime, endTime) {
    ...
    if (!endTime) return `${formattedStart} onwards`;
            ...
            >
              <div className="inline-flex flex-col items-center space-y-1 bg-white/80 px-4 sm:px-6 py-2 sm:py-3 rounded-xl">
                ...
                <p className="text-gray-700 font-medium">
                  {new Date(config.data.agenda[0].date).toLocaleDateString('en-IN', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}
                </p>
              </div>
